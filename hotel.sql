...
--
-- Servidor: localhost
-- Tiempo de generación: 12-06-2017 a las 20:20:19
...
--
-- Base de datos: `u733475653_hotel`
--
...
CREATE TABLE IF NOT EXISTS `habitacion` (
  `codHabitacion` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `reserva` (
  ...
  PRIMARY KEY (`codHabitacion`,`codCliente`,`fechaEntrada`),
  KEY `codCliente` (`codCliente`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
('<p><img style="float: left; margin: 0px 10px;" src="/aplicacion/View/img/uploads/restaurante11.jpg" width="233" height="233" />Descubre los innumerables detalles que nos diferencian de otros hoteles de lujo de Barcelona. Degusta la alta cocina del Restaurante Barcelonas y tonif&iacute;cate con los tratamientos de belleza de nuestro Spa by L''Occitane. Organiza tus eventos especiales en nuestras modernas salas de reuni&oacute;n con la ayuda de nuestros expertos profesionales.</p>\n<p>Probando. ajax compatible.</p>', '<p><img style="float: left; margin: 0px 10px;" src="/aplicacion/View/img/uploads/comedor21.jpg" width="233" height="155" />El comedor, con magn&iacute;ficas vistas, ofrece cocina nacional e internacional&nbsp; y una amplia variedad de especialidades canarias que podr&aacute;s degustar una vez por semana. El hotel dispone de cafeter&iacute;a, restaurante buffet de oferta variada, cocina en vivo y dos bares, uno interior y otro en la piscina. Se requiere pantal&oacute;n largo para cenar en el restaurante.</p>', '<p><img style="float: left; margin: 0px 10px;" src="/aplicacion/View/img/uploads/tipoHab13.jpg" width="223" height="167" />Habitaciones individuales, ideales para viajes de negocios o de relax. Dispone de todo lo necesario para descansar despu&eacute;s de un d&iacute;a intenso. Capacidad m&aacute;xima: una persona. Descubra estas habitaciones modernas y funcionales, ideales para viajes de negocios o de relax. Puede elegir si quiere un dormitorio con vistas a la Rambla de Santa Cruz o bien si lo prefiere con vistas interiores para una mayor tranquilidad. Dispone de todas las comodidades para pasar una estancia inolvidable.</p>', '<p><img style="float: left; margin: 0px 10px;" src="/aplicacion/View/img/uploads/tipoHab24.jpg" width="223" height="167" />Disfrute de estas maravillosas habitaciones completamente equipadas de 20m2 con todo lo necesario para que su estancia sea perfecta. Todas ellas est&aacute;n totalmente insonorizadas para que pueda disponer del m&aacute;ximo confort y descanso. Adem&aacute;s, puede solicitar habitaciones comunicadas si lo desea. Disfrute de la magn&iacute;fica luz de Santa Cruz en nuestras confortables habitaciones de 20m2 decoradas con un estilo moderno y minimalista. Desde su balc&oacute;n o terraza, podr&aacute; contemplar la Rambla principal o la uni&oacute;n de la ciudad con el mar.</p>', 'Hotel Fuente Alegre');
