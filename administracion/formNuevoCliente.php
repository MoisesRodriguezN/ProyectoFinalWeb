 <tr id="filanueva" class="info">
    ...
    <td>
      <input type="text" maxlength="30" size="10" id="nombreNuevo" placeholder="Nombre" value="">
    </td>
    <td>
      <input type="txt" maxlength="30" size="10" id="apellido1Nuevo" placeholder="Apellido 1"value="">
    </td>
    <td>
