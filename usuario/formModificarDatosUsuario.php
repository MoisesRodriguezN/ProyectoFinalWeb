<div>
        <div class="cuadroForm">
            <form action="modificarCliente.php" class="formCentrado" id="formModificar" method="post">
                ...
                <div class="form-group-Usuario">
                    <label class="labelFormDatosUsuario" for="inputApellido">Apellido1:</label>
                    <input type="text" name="apellido1" id="inputApellido" class="form-control-usuario" value="">
                </div>

                <div class="form-group-Usuario">
                    <label class="labelFormDatosUsuario" for="inputApellido2">Apellido2:</label>
                    <input type="text" name="apellido2" id="inputApellido2" class="form-control-usuario" value="">
                </div>
                
                <div class="form-group-Usuario">
                    <label class="labelFormDatosUsuario" for="inputDni">DNI:</label>
                    <input type="text" name="DNI" id="inputDni" class="form-control-usuario" value="">
                </div>
